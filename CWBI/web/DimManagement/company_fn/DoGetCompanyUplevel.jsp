...
<%
    ...
    if (db.dbOpen()) {
        try {
            str_return = "<select size=1 style=\"width:250px;\" id=\"uplevel_id\" name=\"uplevel_id\">";
            str_return += "<option value=\"0\"></option>";
            //下拉框值部分
            String sqlstr = "select distinct company_id,company_name from echarts.dim_company_fn where 1=1 order by order_no";
            ResultSet rs = null;
