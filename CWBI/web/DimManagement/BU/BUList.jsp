...
<%
    String positionStr = "板块信息管理";
    String programName = "板块列表";
%>
<!DOCTYPE html>
<html>
<head>
    ...
    $(function () {
        $('#tg').datagrid({
            ...
            columns: [[
                ...
                {field: 'bu_id', hidden: true},
                {
                    field: 'bu_name', title: '板块名称', width: 30,
                    formatter: function (value, rowData, rowIndex) {
                        var row = "";
                        row += "<a href=\"BUItf.jsp?bu_id=" + rowData.bu_id + "\">" + value + "</a>";
                        return row;
                    }
                },
                {field: 'bu_code', title: '板块编号', width: 20, align: 'center'},
                {field: 'bu_level', title: '板块等级', width: 20, align: 'center'},
                {field: 'uplevel_name', title: '上级板块名称', width: 30, align: 'center'},
                {field: 'status', title: '板块状态', width: 20, align: 'center'},
                {field: 'order_no', title: '板块排序号', width: 30, align: 'center', sortable: true}
            ]]
        });
    });
    function doSearch() {
...
<body bgcolor="#FFFFFF" background="../../images/back.jpg" leftmargin="0" topmargin="0" marginwidth="0"
      marginheight="0">
<form name="f1" method="post" action="BUCtl.jsp">
...
<div id="query_condition">
    <div style="padding: 5px;">
        板块名称：<input style='width:280px;' id='bu_name'></input>
        ...
        <a style="float: right;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true"
           href="javascript:void(0)" onclick="javascript:self.location='BUItf.jsp'">新建</a>
    </div>
</div>
