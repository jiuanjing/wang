...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            if ("asset_liability_ratio".equalsIgnoreCase(target)) {
                sqlstr = "select a.date_id,a." + target + ",b.brief_name from echarts.dm_debt_risk a,echarts.dim_company_fn b where a.company_id = b.company_id";

            } else {
                sqlstr = "select a.date_id,round(a." + target + "/10000,2),b.brief_name from echarts.dm_debt_risk a,echarts.dim_company_fn b where a.company_id = b.company_id";

            }

            String where = " and a." + target + "<> 0 and a.company_id > 2";
