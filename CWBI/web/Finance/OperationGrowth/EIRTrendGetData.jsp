...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select date_id,round(owners_equity_begin/10000,2),round(owners_equity_end/10000,2),equity_increase_rate from echarts.dm_operating_growth";
