...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select date_id,round(operating_revenue_ly/10000,2),round(operating_revenue_ty/10000,2),selling_growth_rate from echarts.dm_operating_growth";
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    str_return = str_return + "'" + rs.getString(1) + ":" + rs.getString(2) + ":" + rs.getString(3) + ":" + rs.getString(4) + "',";
                    rs.next();
                }
