...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
         import="com.bws.dbOperation.DBOperation,com.google.gson.Gson,java.sql.ResultSet" %>
<%
    //实例化数据库链接
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select date_id,round(VAR_COST_PER_UNIT,2),round(VAR_COST_PER_UNIT_LY,2) from echarts.dm_profitability";
