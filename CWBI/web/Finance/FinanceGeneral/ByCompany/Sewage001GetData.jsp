...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.company_id,t.brief_name,t.ROE from (select a.COMPANY_ID,b.brief_name,a.ROE from echarts.dm_profitability a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and a.ROE <> 0 and a.company_id > 2";
