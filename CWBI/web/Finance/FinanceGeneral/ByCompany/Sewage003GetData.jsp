...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.company_id,t.brief_name,t.PROPORTION_OF_THREE_EXPENSE from (select a.COMPANY_ID,b.brief_name,a.PROPORTION_OF_THREE_EXPENSE from echarts.dm_profitability a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and a.PROPORTION_OF_THREE_EXPENSE <> 0 and a.company_id > 2";
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    ...
                    map.put("proportion_of_three_expense", rs.getString(3));
                    list.add(map);
                    rs.next();
                }
            }
