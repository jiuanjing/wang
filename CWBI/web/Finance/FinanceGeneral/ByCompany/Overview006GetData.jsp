...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select date_id,round(OPERATING_REVENUE/10000,2),round(OPERATING_REVENUE_LY/10000,2),round((OPERATING_REVENUE-OPERATING_REVENUE_LY)/10000,2),round(OPERATING_REVENUE_DIF_PRICE/10000,2),round(OPERATING_REVENUE_DIF_QUANTITY/10000,2) from echarts.dm_profitability";
