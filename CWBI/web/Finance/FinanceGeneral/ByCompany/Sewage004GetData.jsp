...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.company_id,t.brief_name,t.COST_PER_UNIT,t.COST_PER_UNIT_YOY from (select a.COMPANY_ID,b.brief_name,a.COST_PER_UNIT,a.COST_PER_UNIT_YOY from echarts.dm_profitability a,echarts.dim_company_fn b"
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    ...
                    map.put("cost_per_unit", rs.getString(3));
                    map.put("cost_per_unit_yoy", rs.getString(4));
                    list.add(map);
                    rs.next();
                }
            }
