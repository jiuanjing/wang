...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select c.dept_name,round(sum(a.operating_revenue_ty)/10000,2) from echarts.dm_operating_growth a ,echarts.dim_company_fn b,echarts.dim_dept c "
            ...
            sqlstr = sqlstr + where + " and b.status=1 and c.status=1 and b.leaf_flag=1 group by c.dept_name order by sum(a.operating_revenue_ty)";
