...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.brief_name,t.OPERATING_CASH_FLOW_MONTHS from (select * from echarts.dm_profitability a,echarts.dim_company_fn b"
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    ...
                    map.put("operating_cash_flow_months", rs.getString(2));
                    list.add(map);
                    rs.next();
                }
            }
