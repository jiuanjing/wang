...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            if (sort.equals("rate")) {
                sort = "(a.PROFIT_CW/a.PROFIT_CW_BUDGET)";
            }
            sqlstr = "select t.brief_name,round(t.PROFIT_CW/10000,2),round(t.PROFIT_CW_BUDGET/10000,2),round((t.PROFIT_CW/t.PROFIT_CW_BUDGET)*100,2) from (select * from echarts.dm_profitability a,echarts.dim_company_fn b where a.company_id = b.company_id";

            String where = "";
            where += " and a.PROFIT_CW_BUDGET <> 0 and a.company_id > 2";
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    ...
                    map.put("profit_cw_budget", df.format(d2));
