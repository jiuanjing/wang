...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            //营业成本占收入比
            String sql1 = "select date_id,round((OPERATING_COST/OPERATING_REVENUE)*100,2) from echarts.dm_profitability t where company_id=1 and OPERATING_REVENUE <> 0" + where + " order by date_id";
            //营业成本占收入比同期
            String sql2 = "select date_id,round((OPERATING_COST/OPERATING_REVENUE)*100,2) from echarts.dm_profitability t where company_id=1 and OPERATING_REVENUE <> 0" + where1 + " order by date_id";
