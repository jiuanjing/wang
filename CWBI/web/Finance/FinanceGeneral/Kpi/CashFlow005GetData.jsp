...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select b.brief_name,round((a.NET_OPERATING_CASH_FLOW)/10000,2) from echarts.dm_debt_risk a ,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and a.NET_OPERATING_CASH_FLOW <>0 and a.company_id>2";
            ...
            sqlstr = sqlstr + where + " and b.status=1 and b.company_level=2 order by a.NET_OPERATING_CASH_FLOW desc";
            ResultSet rs = null;
