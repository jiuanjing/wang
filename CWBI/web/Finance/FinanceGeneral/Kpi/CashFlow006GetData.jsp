...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.brief_name,t.CCDR from (select * from echarts.dm_debt_risk a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and a.CCDR <> 0 and a.company_id > 2";
