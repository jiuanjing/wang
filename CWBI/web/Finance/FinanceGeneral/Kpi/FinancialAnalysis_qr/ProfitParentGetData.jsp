...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            int t_date = 0;
            sqlstr = "select round(PROFIT_PARENT/10000,2),round(PROFIT_PARENT_LY/10000,2) from echarts.DM_QR_CW where 1=1";
            String where = "";
