...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            int t_date = 0;
            sqlstr = "select round(TOTAL_PROFIT/10000,0),round(TOTAL_PROFIT_LY/10000,0) from echarts.DM_QR_CW where 1=1";
            String where = "";
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    ...
                    map2.put("value", Integer.parseInt(rs.getString(2)));
                    map2.put("name", "上期利润总额");
                    t_list.add(map2);
