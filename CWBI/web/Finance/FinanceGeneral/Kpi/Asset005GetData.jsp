...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select round(a.total_asset/10000,2),b.brief_name from echarts.dm_debt_risk a,echarts.dim_company_fn b where a.company_id = b.company_id";
            ...
            sqlstr = sqlstr + where + " and a.company_id > 2 and a.total_asset <> 0 and b.status=1 and b.company_level=2 order by a.total_asset desc";
