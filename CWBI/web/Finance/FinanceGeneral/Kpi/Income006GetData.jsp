...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.brief_name,round(t.operating_revenue_ty/10000,2),round(t.operating_revenue_ly/10000,2),t.selling_growth_rate from (select * from echarts.dm_operating_growth a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and a.company_id > 2";
            ...
            sqlstr = sqlstr + where + " and b.status=1 and b.company_level=2 order by a." + sort + " " + order + ") t where rownum<=10";
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    ...
                    map.put("operating_revenue_ty", df.format(d));
                    Double d1 = Double.parseDouble(rs.getString(3));
                    map.put("operating_revenue_ly", df.format(d1));
                    map.put("selling_growth_rate", rs.getString(4));
                    list.add(map);
                    rs.next();
                }
            }
