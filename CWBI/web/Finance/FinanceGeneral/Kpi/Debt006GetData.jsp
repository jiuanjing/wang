...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.brief_name,t.asset_liability_ratio from (select * from echarts.dm_debt_risk a,echarts.dim_company_fn b where a.company_id = b.company_id";

            String where = "";
            where += " and a.asset_liability_ratio <> 0 and a.company_id > 2";
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    ...
                    map.put("asset_liability_ratio", rs.getString(2));
                    list.add(map);
                    rs.next();
                }
            }
