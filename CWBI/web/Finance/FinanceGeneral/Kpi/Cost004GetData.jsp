...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            if (sort.equals("rate")) {
                sort = "(a.MANAGEMENT_EXPENSE/a.OPERATING_REVENUE)";
            }
            sqlstr = "select t.brief_name,round(t.MANAGEMENT_EXPENSE/10000,2),round(t.OPERATING_REVENUE/10000,2),round((t.MANAGEMENT_EXPENSE/t.OPERATING_REVENUE)*100,2) from (select * from echarts.dm_profitability a,echarts.dim_company_fn b"
                    + " where a.company_id = b.company_id and a.OPERATING_REVENUE <> 0 and a.company_id > 2";
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    ...
                    map.put("management_expense", df.format(d));
