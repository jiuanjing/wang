...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select t.brief_name,round(t.OPERATING_COST/10000,2),round(t.OPERATING_REVENUE/10000,2),round((t.OPERATING_COST/t.OPERATING_REVENUE)*100,2) from (select * from echarts.dm_profitability a,echarts.dim_company_fn b"
