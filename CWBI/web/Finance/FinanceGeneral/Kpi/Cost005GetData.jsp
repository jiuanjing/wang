...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            if (sort.equals("rate")) {
                sort = "(a.FINANCIAL_EXPENSE/a.OPERATING_REVENUE)";
            }
            sqlstr = "select t.brief_name,round(t.FINANCIAL_EXPENSE/10000,2),round(t.OPERATING_REVENUE/10000,2),round((t.FINANCIAL_EXPENSE/t.OPERATING_REVENUE)*100,2) from (select * from echarts.dm_profitability a,echarts.dim_company_fn b"
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    ...
                    map.put("financial_expense", df.format(d));
