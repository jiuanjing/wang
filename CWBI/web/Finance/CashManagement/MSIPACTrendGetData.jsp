...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select date_id,round(money_saved_in_parent/10000,2),round(money_saved_in_parent_change/10000,2),round(money_saved_in_parent_budget/10000,2),round(money_saved_in_parent_c_budget/10000,2) from echarts.dm_monetary_handin";
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    str_return = str_return + "'" + rs.getString(1) + ":" + rs.getString(2) + ":" + rs.getString(3) + ":" + rs.getString(4) + ":" + rs.getString(5) + "',";
                    rs.next();
                }
