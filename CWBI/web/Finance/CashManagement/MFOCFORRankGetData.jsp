...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            if ("mfocfor".equalsIgnoreCase(target)) {
                sqlstr = "select a.date_id,a." + target + ",b.brief_name from echarts.dm_monetary_fund a,echarts.dim_company_fn b where a.company_id = b.company_id";

            } else {
                sqlstr = "select a.date_id,round(a." + target + "/10000,2),b.brief_name from echarts.dm_monetary_fund a,echarts.dim_company_fn b where a.company_id = b.company_id";
