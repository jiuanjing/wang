<%
    /*********************************************************************************************************************
     *程序名称：HandinRateRankGetData.jsp
    ...
    if (db.dbOpen()) {
        try {
            ...
            if ("handin_rate".equalsIgnoreCase(target)) {
                sqlstr = "select a.date_id,a." + target + ",b.brief_name from echarts.dm_monetary_handin a,echarts.dim_company_fn b where a.company_id = b.company_id";

            } else {
                sqlstr = "select a.date_id,round(a." + target + "/10000,2),b.brief_name from echarts.dm_monetary_handin a,echarts.dim_company_fn b where a.company_id = b.company_id";
