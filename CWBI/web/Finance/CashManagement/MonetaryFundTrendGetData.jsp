<%
    /*********************************************************************************************************************
     *程序名称：MonetaryFundTrendGetData.jsp
...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select date_id,round(average_monetary_fund/10000,2),round(monetary_fund_budget/10000,2) from echarts.dm_monetary_fund";
