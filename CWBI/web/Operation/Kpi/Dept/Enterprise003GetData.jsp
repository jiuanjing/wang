...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            sqlstr = "select b.brief_name,round((a.operating_revenue)/10000,2) from echarts.dm_profitability a ,echarts.dim_company_fn b"
            ...
            sqlstr = sqlstr + where + " and b.status=1 and b.company_level=2 order by a.operating_revenue desc";
            ResultSet rs = null;
            ...
            str_return = "['name:test','value:100']";
