...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=2020 and t.date_id = " + (year - 1);//同期吨水电耗
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=2020 and t.date_id = " + year;//实际吨水电耗
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=2020 and t.date_id = " + year;//计划吨水电耗
            ...
            Map<String, Object> map1 = new HashMap<String, Object>();//吨水电耗同期值
            Map<String, Object> map2 = new HashMap<String, Object>();//吨水电耗实际值
            Map<String, Object> map3 = new HashMap<String, Object>();//吨水电耗预算值
            map1.put("kpi", "吨水电耗同期值(kwh/千吨)");
            map2.put("kpi", "吨水电耗实际值(kwh/千吨)");
            map3.put("kpi", "吨水电耗预算值(kwh/千吨)");
