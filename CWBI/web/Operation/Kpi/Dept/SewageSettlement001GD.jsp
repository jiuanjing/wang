...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id = " + DeptID + " and t.kpi_code_num=2015 and t.date_id = " + (year - 1);//同期结算水量
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id = " + DeptID + " and t.kpi_code_num=2015 and t.date_id = " + year;//实际结算水量
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget_sum t where t.sum_id = " + DeptID + " and t.kpi_code_num=2015 and t.date_id = " + year;//计划结算水量
            ...
            List<String> list5 = new ArrayList<String>();//结算量同比增长率
            List<String> list6 = new ArrayList<String>();//结算量计划完成率
