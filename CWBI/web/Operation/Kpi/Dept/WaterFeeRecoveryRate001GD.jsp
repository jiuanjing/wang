...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=1003 and t.date_id = " + year;//同期水费回收率
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=1003 and t.date_id = " + (year - 1);//实际水费回收率
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=1003 and t.date_id = " + (year - 1);//计划水费回收率
