...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=1063 and t.date_id = " + (year - 1);//同期主营人均产值
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=1063 and t.date_id = " + year;//实际主营人均产值
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=1063 and t.date_id = " + year;//计划主营人均产值
            ...
            Map<String, Object> map1 = new HashMap<String, Object>();//主营人均产值同期值
            Map<String, Object> map2 = new HashMap<String, Object>();//主营人均产值实际值
            Map<String, Object> map3 = new HashMap<String, Object>();//主营人均产值预算值
            map1.put("kpi", "主营人均产值同期值(万元/人)");
            map2.put("kpi", "主营人均产值实际值(万元/人)");
            map3.put("kpi", "主营人均产值预算值(万元/人)");
