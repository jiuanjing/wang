...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select nvl(round(sum(sum" + month + "),2),0) from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id = " + DeptID + " and t.kpi_code_num=1025 and t.date_id = " + year;//实际供水量
            String sqlstr2 = "select nvl(round(sum(sum" + month + "),2),0) from echarts.dm_op_mr_kpi_budget_sum t where t.sum_id = " + DeptID + " and t.kpi_code_num=1025 and t.date_id = " + year;//计划供水量
