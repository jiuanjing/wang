...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id = " + DeptID + " and t.kpi_code_num=2041 and t.date_id = " + (year - 1);//同期设计水量
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id = " + DeptID + " and t.kpi_code_num=2041 and t.date_id = " + year;//设计水量实际值
