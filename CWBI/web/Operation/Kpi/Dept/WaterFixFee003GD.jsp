...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=1062 and t.date_id = " + (year - 1);//同期吨水维修费
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=1062 and t.date_id = " + year;//实际吨水维修费
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget_sum t where t.sum_id=" + DeptID + " and t.kpi_code_num=1062 and t.date_id = " + year;//计划吨水维修费
            ...
            Map<String, Object> map1 = new HashMap<String, Object>();//吨水维修费同期值
            Map<String, Object> map2 = new HashMap<String, Object>();//吨水维修费实际值
            Map<String, Object> map3 = new HashMap<String, Object>();//吨水维修费预算值
            map1.put("kpi", "吨水维修费同期值(元/千吨)");
            map2.put("kpi", "吨水维修费实际值(元/千吨)");
            map3.put("kpi", "吨水维修费预算值(元/千吨)");
