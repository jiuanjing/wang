...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1038 and t.date_id = " + (year - 1);//同期吨水电耗
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1038 and t.date_id = " + year;//吨水电耗实际值
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=1038 and t.date_id = " + year;//吨水电耗计划
            ...
            map1.put("kpi", "吨水电耗量同期值(kwh/千吨)");
            map2.put("kpi", "吨水电耗量实际值(kwh/千吨)");
            map3.put("kpi", "吨水电耗量预算值(kwh/千吨)");
