...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2026 and t.date_id = " + (year - 1);//同期吨水药耗
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2026 and t.date_id = " + year;//吨水药耗实际值
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=2026 and t.date_id = " + year;//吨水药耗计划
            ...
            map1.put("kpi", "吨水药耗量同期值(元/千吨水)");
            map2.put("kpi", "吨水药耗量实际值(元/千吨水)");
            map3.put("kpi", "吨水药耗量预算值(元/千吨水)");
