...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1002 and t.date_id = " + (year - 1);//同期应收
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1002 and t.date_id = " + year;//应收实际值
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=1002 and t.date_id = " + year;//应收计划
            ...
            map1.put("kpi", "应收水费同期值(万元)");
            map2.put("kpi", "应收水费实际值(万元)");
            map3.put("kpi", "应收水费预算值(万元)");
