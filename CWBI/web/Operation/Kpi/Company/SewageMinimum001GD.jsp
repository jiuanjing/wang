...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2013 and t.date_id = " + (year - 1);//同期保底水量
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2013 and t.date_id = " + year;//实际保底水量
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=2013 and t.date_id = " + year;//计划保底水量
            ...
            List<String> list5 = new ArrayList<String>();//保底水量同比增长率
            List<String> list6 = new ArrayList<String>();//保底水量计划完成率
