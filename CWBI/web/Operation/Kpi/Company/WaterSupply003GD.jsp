...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1025 and t.date_id = " + (year - 1);//同期供水
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1025 and t.date_id = " + year;//供水实际值
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=1025 and t.date_id = " + year;//供水计划
            ...
            map1.put("kpi", "供水量同期值(万吨)");
            map2.put("kpi", "供水量实际值(万吨)");
            map3.put("kpi", "供水量计划值(万吨)");
