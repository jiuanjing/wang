...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1022 and t.date_id = " + (year - 1);//同期制水
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1022 and t.date_id = " + year;//制水实际值
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=1022 and t.date_id = " + year;//制水计划
            ...
            map1.put("kpi", "制水量同期值(万吨)");
            map2.put("kpi", "制水量实际值(万吨)");
            map3.put("kpi", "制水量预算值(万吨)");
