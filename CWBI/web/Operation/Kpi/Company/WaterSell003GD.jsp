...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1028 and t.date_id = " + (year - 1);//同期售水
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1028 and t.date_id = " + year;//售水实际值
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=1028 and t.date_id = " + year;//售水计划
            ...
            map1.put("kpi", "售水量同期值(万吨)");
            map2.put("kpi", "售水量实际值(万吨)");
            map3.put("kpi", "售水量计划值(万吨)");
