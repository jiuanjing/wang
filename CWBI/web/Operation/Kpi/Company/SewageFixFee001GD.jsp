...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2049 and t.date_id = " + (year - 1);//同期吨水维修费
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2049 and t.date_id = " + year;//吨水维修费实际值
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=2049 and t.date_id = " + year;//吨水维修费计划
            ...
            List<String> list5 = new ArrayList<String>();//吨水维修费量同比增长率
            List<String> list6 = new ArrayList<String>();//吨水维修费量计划完成率
