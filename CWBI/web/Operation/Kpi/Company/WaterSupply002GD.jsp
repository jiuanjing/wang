...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select nvl(round(sum(sum" + month + "),2),0) from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1025 and t.date_id = " + year;//制水实际值
            String sqlstr2 = "select nvl(round(sum(sum" + month + "),2),0) from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=1025 and t.date_id = " + year;//制水计划
