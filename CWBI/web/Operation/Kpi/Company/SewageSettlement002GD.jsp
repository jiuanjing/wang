...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select nvl(round(sum" + month + ",2),0) from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2013 and t.date_id = " + year;//实际结算水量
            String sqlstr2 = "select nvl(round(sum" + month + ",2),0) from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=2013 and t.date_id = " + year;//计划结算水量
