...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2026 and t.date_id = " + (year - 1);//同期吨水药耗
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2026 and t.date_id = " + year;//吨水药耗实际值
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=2026 and t.date_id = " + year;//吨水药耗计划
            ...
            List<String> list5 = new ArrayList<String>();//吨水药耗量同比增长率
            List<String> list6 = new ArrayList<String>();//吨水药耗量计划完成率
