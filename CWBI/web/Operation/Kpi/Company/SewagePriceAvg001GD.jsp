...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2050 and t.date_id = " + (year - 1);//同期平均水价
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2050 and t.date_id = " + year;//平均水价实际值
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=2050 and t.date_id = " + year;//平均水价计划
            ...
            List<String> list5 = new ArrayList<String>();//平均水价量同比增长率
            List<String> list6 = new ArrayList<String>();//平均水价量计划完成率
