...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2048 and t.date_id = " + (year - 1);//同期吨水管理费
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2048 and t.date_id = " + year;//吨水管理费实际值
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=2048 and t.date_id = " + year;//吨水管理费计划
            ...
            map1.put("kpi", "吨水管理费量同期值(元/千吨)");
            map2.put("kpi", "吨水管理费量实际值(元/千吨)");
            map3.put("kpi", "吨水管理费量预算值(元/千吨)");
