...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2001 and t.date_id = " + (year - 1);//同期应收
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=2001 and t.date_id = " + year;//应收实际值
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=2001 and t.date_id = " + year;//应收计划
            ...
            List<String> list5 = new ArrayList<String>();//应收水费同比增长率
            List<String> list6 = new ArrayList<String>();//应收水费计划完成率
