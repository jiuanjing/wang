...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1034 and t.date_id = " + (year - 1);//同期产销差率
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1034 and t.date_id = " + year;//产销差率实际值
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=1034 and t.date_id = " + year;//产销差率计划
            ...
            List<String> list5 = new ArrayList<String>();//产销差率同比差异
            List<String> list6 = new ArrayList<String>();//产销差率预算差异
