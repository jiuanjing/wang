...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + colume + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1059 and t.date_id = " + (year - 1);//同期制水
            String sqlstr2 = "select " + colume + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1059 and t.date_id = " + year;//制水实际值
            ...
            List<String> list5 = new ArrayList<String>();//设计水量同比增长率
