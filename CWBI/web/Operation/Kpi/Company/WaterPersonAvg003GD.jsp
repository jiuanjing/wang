...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1064 and t.date_id = " + (year - 1);//同期主营人均产值
            String sqlstr2 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_actual t where t.company_id = " + CompanyID + " and t.kpi_code_num=1064 and t.date_id = " + year;//主营人均产值实际值
            String sqlstr3 = "select " + column + "," + sumcolumn + " from echarts.dm_op_mr_kpi_budget t where t.company_id = " + CompanyID + " and t.kpi_code_num=1064 and t.date_id = " + year;//主营人均产值计划
            ...
            map1.put("kpi", "主营人均产值量同期值(万元/人)");
            map2.put("kpi", "主营人均产值量实际值(万元/人)");
            map3.put("kpi", "主营人均产值量预算值(万元/人)");
