...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.kpi_code_num=1059 and t.sum_id = 0 and t.date_id = " + (year - 1);//同期设计水量
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.kpi_code_num=1059 and t.sum_id = 0 and t.date_id = " + year;//设计水量实际值
