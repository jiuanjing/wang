...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.kpi_code_num=1001 and t.sum_id = 0 and t.date_id = " + (year - 1);//同期应收水费
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.kpi_code_num=1001 and t.sum_id = 0 and t.date_id = " + year;//实际应收水费
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget_sum t where t.kpi_code_num=1001 and t.sum_id = 0 and t.date_id = " + year;//计划应收水费
