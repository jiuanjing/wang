...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select nvl(round(sum" + month + ",2),0) from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id = 0 and t.kpi_code_num=1065 and t.date_id =" + year;
            String sqlstr2 = "select nvl(round(sum" + month + ",2),0) from echarts.dm_op_mr_kpi_budget_sum t where t.sum_id = 0 and t.kpi_code_num=1065 and t.date_id =" + year;
