...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr1 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=0 and t.kpi_code_num=1061 and t.date_id = " + (year - 1);//同期吨水管理费
            String sqlstr2 = "select " + column + " from echarts.dm_op_mr_kpi_actual_sum t where t.sum_id=0 and t.kpi_code_num=1061 and t.date_id = " + year;//实际吨水管理费
            String sqlstr3 = "select " + column + " from echarts.dm_op_mr_kpi_budget_sum t where t.sum_id=0 and t.kpi_code_num=1061 and t.date_id = " + year;//预算吨水管理费
