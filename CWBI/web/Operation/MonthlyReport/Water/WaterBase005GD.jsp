    ...
    if (db.dbOpen()) {
        try {
            ...
            String date = request.getParameter("date");
				/* 查询公司股东信息 */
            String sqlstr = "";
            sqlstr = "select t.year_id,t.DN15_THICKER,t.DN15,t.DN15_THICKER_REMOTE,t.DN15_REMOTE"
                    + " from echarts.dm_op_mr_basic_meter_w t where 1=1";
            String where = "";
            ...
            if (intRowCount > 0) {
                ...
                while (!rs.isAfterLast()) {
                    ...
                    map.put("dn15_thicker", rs.getString(2));
                    map.put("dn15", rs.getString(3));
                    map.put("dn15_thicker_remote", rs.getString(4));
                    map.put("dn15_remote", rs.getString(5));
                    list_a.add(map);
                    rs.next();
                }
            } else {
                for (int i = 0; i < 3; i++) {
                    Map<String, Object> map = new HashMap<String, Object>();
                    map.put("year_id", "");
                    map.put("dn15_thicker", "");
                    map.put("dn15", "");
                    map.put("dn15_thicker_remote", "");
                    map.put("dn15_remote", "");
                    list_a.add(map);
                }
            }
