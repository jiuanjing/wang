...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr = "select module_id,module_code \"模块编号\",module_name \"模块名称\",URL,module_level \"模块级别\",order_NO \"排序号\",status \"状态\",help_URL \"帮助的URL地址\",add_value_URL \"红宝书地址\" from bim.module";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td height="21" align="right">
                                                                ...
                                                                <input name="addNew" type="button" class="button"
                                                                       value="新建"
                                                                       onclick="self.location='ModuleItf.jsp'">
