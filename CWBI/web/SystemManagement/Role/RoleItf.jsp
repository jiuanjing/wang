<%
    /*********************************************************************************************************************
     *程序名称：RoleItf.jsp
     *功能描述：显示角色信息的界面程序，如果传入一个角色的编号则显示该角色的具体内容，否则显示新增界面
     *编写人：万怀
     *编写时间：2014-09-17
     **********************************************************************************************************************/
%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"
         import="com.bws.dbOperation.DBOperation,com.bws.util.RoleObj" %>
...
<%
    ...
    String positionStr = "角色信息维护";//当前位置
    String programName = "新增/修改角色信息";//当前功能名称
...
<head>
    ...
    <script type="text/javascript">
        function sendReq(str) {
            ...
            f2.action = "RoleCtl.jsp?type=" + str
            f2.submit();
        }
...
<body bgcolor="#FFFFFF" background="../../images/back.jpg" leftmargin="0" topmargin="0" marginwidth="0"
      marginheight="0">
<form method="post" name="f2" action="RoleCtl.jsp">
    <input type="hidden" name="RoleID" size="11" value="<%=Obj.getRoleID() %>">
                                                ...
                                                <table width="100%" height="25" border="0" cellpadding="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        %><input name="addNew" type="button" class="button" value="新建"
                                                                 onclick="javascript:self.location='RoleItf.jsp'"><input
                                                        ...
                                                        %><INPUT class="button"
                                                                 ...
                                                                 type=button value=刷新 name=refesh><input name="back_but"
                                                                                                         ...
                                                                                                         class="button"
                                                                                                         value="返回"
                                                                                                         onclick="javascript:self.location='RoleList.jsp';">
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        <tr>
                                            <td>
                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                    <tr>
                                                        <td width="13%" align="right" height="30">角色名称：</td>
                                                        <td width="32%" align="left" height="30">
                                                            <input type="text" name="RoleName" size="50"
                                                                   value="<%=Obj.getRoleName() %>">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="13%" align="right" height="30">角色描述：</td>
                                                        <td width="32%" align="left" height="30">
                                                            <input type="text" name="RoleDesc" size="50"
                                                                   value="<%=Obj.getRoleDesc() %>">
                                                        </td>
                                                    </tr>
                                                    <tr>
