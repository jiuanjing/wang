...
<%
    ...
    if (db.dbOpen()) {
        try {
            ...
            //取检索条件
            String where = "";
            if (request.getParameter("UserAccount") != null && request.getParameter("UserAccount").trim().length() > 0) {
                where = where + " and user_account like '%" + ChStr.chStr(request.getParameter("UserAccount").trim()) + "%'";
            }
            if (request.getParameter("UserName") != null && request.getParameter("UserName").trim().length() > 0) {
                where = where + " and user_name like '%" + ChStr.chStr(request.getParameter("UserName").trim()) + "%'";
            }

            sqlstr = sqlstr + where;//追加检索条件
            sqlstr = sqlstr + " order by user_id";
...
<script>
    ...
    {
        tab_list.UserAccount.value = "";
        tab_list.UserName.value = "";
    }
    ...
    function deleteChoosedItems() {
        ...
        document.tab_list.action = "UserCtl.jsp";
...
<table width="98%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td height="18"><span id="lbCurPos" class="lbl2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>>>><%=positionStr%></span>
        </td>
    </tr>
    <tr>
        <td>
                ...
                <tr>
                    <td width="94%" align="left" valign="top">
                        <table id="table1" border="0" cellspacing="0" align="center" width="95%">
                            ...
                            <tr>
                                <td>
                                    <form name="tab_list" method="POST" action="UserList.jsp">
                                        ...
                                        <table id="Table2" class="tab1">
                                                ...
                                                <td colspan="15">
                                                    <div id="frmTitle" style="display:none">
                                                        <table id="t1" class="tab1" width="100%">
                                                            ...
                                                            <tr>
                                                                <td>登录账号： <input name="UserAccount" type="text" size=12
                                                                                 value=""/>
                                                                    用户名称：<input name="UserName" type="text" size=12
                                                                                value=""/>
                                            ...
                                            <tr  <%=bgcolor%> onclick='setRowIndex(this)'>
                                                ...
                                                <td align="center" nowrap><a
                                                        href='UserItf.jsp?UserID=<%=rs.getString(1)%>'><%=rs.getString(col)%>
                                                </a></td>
                                                <%
                                                } else {%>
