...
<%
    ...
    String positionStr = "角色授权管理";//当前位置
    ...
    if (db.dbOpen()) {
        try {
            ...
            String sqlstr_module_list = "select module_id,module_code \"模块编号\",module_name \"模块名称\",URL,module_level \"模块级别\",order_NO \"排序号\",status \"状态\",help_URL \"帮助的URL地址\",add_value_URL \"红宝书地址\" from module where status=1";
            //String sqlstr = "select b.module_id,module_code \"模块编号\",module_name \"模块名称\",URL,module_level \"模块级别\",order_NO \"排序号\",status \"状态\",help_URL \"帮助的URL地址\",add_value_URL \"红宝书地址\" from module b,role_module a";
            //sqlstr = sqlstr + " where a.module_id=b.module_id and a.role_id=" + RoleID;
            ...
            sqlstr_module_list = sqlstr_module_list + where;//追加检索条件
                ...
                <tr>
                    <td width="94%" align="left" valign="top">
                        <table id="table1" border="0" cellspacing="0" align="center" width="95%">
                            ...
                            <tr>
                                <td>
                                    <form name="tab_list" method="POST" action="RoleModuleSave.jsp">
                                                    ...
                                                    <table width="100%" height="25" border="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td height="21" align="right">
                                                                <input name="addNew" type="submit" class="button"
                                                                       value="保存">
