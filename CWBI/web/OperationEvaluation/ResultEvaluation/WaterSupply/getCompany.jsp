...
<%
    ...
    if (db.dbOpen()) {
        ...
        if (type1 == 1){
            ...
            //select distinct t.brief_name from echarts.dim_op_company t,dm_op_yr_evaluate t1 where t.company_id = t1.company_id and t.flag_sewage = 1
        }else if(type1 == 4){
            ...
            ////select distinct t.brief_name from echarts.dim_op_company t,dm_op_yr_evaluate t1 where t.company_id = t1.company_id and t.flag_solid_waste = 1
        }
