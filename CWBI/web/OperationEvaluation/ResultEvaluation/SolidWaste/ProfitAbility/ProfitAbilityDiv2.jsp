...
<%
    ...
    if (dbOperation.dbOpen()) {
        ...
        String sql = "select t1.brief_name," +
                "       sum(score) as score," +
                "       sum(decode(t.kpi_id, 4101, t.actual_value, null)) as kpi4101," +
                "       sum(decode(t.kpi_id, 4102, t.actual_value, null)) as kpi4102," +
                "       sum(decode(t.kpi_id, 4103, t.actual_value, null)) as kpi4103," +
                "       sum(decode(t.kpi_id, 4104, t.actual_value, null)) as kpi4104" +
