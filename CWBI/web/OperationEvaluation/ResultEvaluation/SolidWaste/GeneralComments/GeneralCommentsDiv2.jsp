...
<%
    ...
    if (dbOperation.dbOpen()) {
        ...
        String sql = "select t1.brief_name," +
                "       sum(score) as score," +
                "       sum(decode(t.kpi_id, 4100, t.actual_value, null)) as kpi4100," +
                "       sum(decode(t.kpi_id, 4200, t.actual_value, null)) as kpi4200," +
                "       sum(decode(t.kpi_id, 4300, t.actual_value, null)) as kpi4300," +
                "       sum(decode(t.kpi_id, 4400, t.actual_value, null)) as kpi4400," +
                "       sum(decode(t.kpi_id, 4500, t.actual_value, null)) as kpi4500," +
                "       sum(decode(t.kpi_id, 4600, t.actual_value, null)) as kpi4600," +
                "       sum(decode(t.kpi_id, 4700, t.actual_value, null)) as kpi4700" +
