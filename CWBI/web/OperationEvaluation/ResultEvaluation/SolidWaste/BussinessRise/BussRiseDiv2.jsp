...
<%
    ...
    if (dbOperation.dbOpen()) {
        ...
        String sql = "select t1.brief_name," +
                "       sum(score) as score," +
                "       sum(decode(t.kpi_id, 4501, t.actual_value, null)) as kpi4501," +
                "       sum(decode(t.kpi_id, 4502, t.actual_value, null)) as kpi4502," +
                "       sum(decode(t.kpi_id, 4503, t.actual_value, null)) as kpi4503" +
