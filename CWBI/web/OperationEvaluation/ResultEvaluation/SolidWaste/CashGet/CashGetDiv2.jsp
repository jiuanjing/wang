...
<%
    ...
    if (dbOperation.dbOpen()) {
        ...
        String sql = "select t1.brief_name," +
                "       sum(score) as score," +
                "       sum(decode(t.kpi_id, 4301, t.actual_value, null)) as kpi4301," +
                "       sum(decode(t.kpi_id, 4302, t.actual_value, null)) as kpi4302," +
                "       sum(decode(t.kpi_id, 4303, t.actual_value, null)) as kpi4303" +
