...
<%
    ...
    if (dbOperation.dbOpen()) {
        ...
        //获取标杆值
        String sql1 = "select t.actual_value from dm_op_yr_evaluate t ,dim_op_company t2 where t.date_id = " + dateID
                + " and t.kpi_id in (101,102,103,104,105,106) and t.company_id = t2.company_id and t2.brief_name = '" + company + "'";
        //获取第一年实际值
