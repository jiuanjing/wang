...
public class UserRoleObj //extends entityObj
{
    ...
    public boolean Load(String RoleID, DBOperation db) {
        ...
        ve = db.executeQueryVt("select RoleID,RoleName from bim.UserRole where " + "RoleID= " + RoleID);
    ...
    public String getInStr() {
        String str = "";
        str = " insert into bim.UserRole(RoleID,RoleName) values(" + this.RoleID + "," + "'" + this.RoleName + "'" + ")";
        return str;
    }

    public String getUpdateStr() {
        String str = "";
        str = "update bim.UserRole set " + "RoleID=" + RoleID + "," + "RoleName='" + RoleName + "'" + " where " + "RoleID= " + RoleID;
        return str;
    }

    public String getDelStr() {
        String str = "";
        str = "delete from bim.UserRole where " + "RoleID= " + RoleID;
        return str;
    }
}